========================================================================
    BIBLIOTHÈQUE DE LIENS DYNAMIQUES : Vue d'ensemble du projet InteractiveDictionary
========================================================================

AppWizard a créé cette DLL InteractiveDictionary pour vous.  

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application InteractiveDictionary.

InteractiveDictionary.vcxproj
...
InteractiveDictionary.vcxproj.filters
...
InteractiveDictionary.cpp
    Il s'agit du fichier source principal de la DLL.

InteractiveDictionary.h
