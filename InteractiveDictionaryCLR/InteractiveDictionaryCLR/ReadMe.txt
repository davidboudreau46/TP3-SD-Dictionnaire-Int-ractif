========================================================================
    BIBLIOTHÈQUE DE LIENS DYNAMIQUES : Vue d'ensemble du projet InteractiveDictionaryCLR
========================================================================

AppWizard a créé cette DLL InteractiveDictionaryCLR pour vous.  

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application InteractiveDictionaryCLR.

InteractiveDictionaryCLR.vcxproj
...
InteractiveDictionaryCLR.vcxproj.filters
