========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet InteractiveDictionaryLibs
========================================================================

AppWizard a créé ce projet de bibliothèque InteractiveDictionaryLibs à votre intention.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application InteractiveDictionaryLibs.


InteractiveDictionaryLibs.vcxproj
...
InteractiveDictionaryLibs.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) InteractiveDictionaryLibs.pch et un fichier de type précompilé nommé StdAfx.obj.
